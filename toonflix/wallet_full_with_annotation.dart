...
import 'package:toonflix/currencycard.dart'; // 이 줄은 자동생성되었음. setting.json의 "source.organizeImports": "explicit"가 한 일.
...
● 노란 전구: Extract Widget 기능 등등...
            - Extract Widget을 쓰고 하드 코딩된 값들을 field로 바꿀 때, 'Argument of...' 에러 표시 생김.
              : 더 이상 const가 아니라서(변수로 바꿨으니까)
